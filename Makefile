...
hostname		:
				@ echo "127.0.0.1 rdeyirme.42.fr" >> /etc/hosts

#This rule if does not exist create volume folders
volume_dir		:
				@ mkdir -p /home/rdeyirme/data/wordpress
				@ mkdir -p /home/rdeyirme/data/mariadb
